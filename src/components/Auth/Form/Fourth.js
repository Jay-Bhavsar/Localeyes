          ...
          <center>
            {isStep4 ? (
              <form onSubmit={handleForm4Submit} className="">
                ...
                <div className="flex flex-col justify-center">
                  <center>
                    ...
                    <label htmlFor="" className="p-2 bg-blue-200">
                      Attach an authorization document from the Institute/
                    ...
                    <label className="flex flex-col bg-blue-200 w-[50%] p-2">
                      ...
                      <input
                        ...
                        value={form4Data.cover_page_text || ""}
                        onChange={handleForm4InputChange}
                      ...
                      {/* <div className="flex flex-col">
                        <label className="flex items-center p-2">
                          <input
                            ...
                            name="ANVIL"
                            value="software"
                            checked={form4Data.ANVIL === "software"}
                            onChange={handleForm4InputChange}
                            // disabled={form4Data}
                          />
                        ...
                        <label className="flex items-center p-2">
                          <input
                            ...
                            name="Cielo24"
                            value="software"
                            checked={form4Data.cielo24 === "software"}
                            onChange={handleForm4InputChange}
                            // disabled={form4Data}
                          />
                ...
                <button type="submit bg-red-900" disabled={form4Submitted}>
                  Submit
                </button>
                <br />
                <br />
              ...
              <p className="mt-10 mb-36">
                Please fill out the Third Form first
              </p>
            )}
          </center>
        </center>
