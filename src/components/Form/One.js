...
function One() {
  ...
  async function handleForm1Submit(e) {
    ...
    try {
      ...
      pdf.text(`Name: ${form1Data.name}`, 10, 20); 
      pdf.text(`Email: ${form1Data.email}`, 10, 30); 
  
      if (file) {
        const fileRef = storageRef.child(`authorizationDocuments/${alphanumericCode}`);
      ...
      const pdfRef = storageRef.child(`pdfs/form_data_${alphanumericCode}.pdf`);
          ...
          <div className="flex flex-col  shadow-xl w-[100%] md:w-[50%]">
            ...
            <center>
              ...
              >
                ...
                <div className="flex flex-col md:flex-row w-[50%]  justify-center">
                ...
                <center>
                  <h2 className="font-bold" id="part2">
                    Details of Principal investigator or overall trial
                ...
                <div className="flex flex-row w-[100%]">
                  ...
                  <label className="flex flex-col  p-2  w-[50%] font-bold" id="part3">
                    14.Name:
                    <input
                      type="text"
                ...
                <div className="flex flex-row w-[100%]">
                  ...
                  <label className="flex flex-col p-2  w-[50%] font-bold">
                    <h4>
                      17.Title of MSS<span className="text-red-600">*</span>:
                    </h4>
                    <input
                      type="text"
                      name="MSS_title"
                ...
                <div className="flex flex-row w-[100%]">
                  <label className="flex flex-col p-2  w-[50%] font-bold">
                    <h4>
                      18.Given Title<span className="text-red-600">*</span>:
                    </h4>
                    <input
                      type="text"
                      name="given_title"
                ...
                <div className="flex flex-row w-[100%]">
                  ...
                  <label className="flex flex-col p-2  w-[50%] font-bold">
                    <h4>
                      21.MSS OWNER<span className="text-red-600">*</span>:
                    </h4>
                    <input
                      type="text"
                      name="MSS_owner"
                ...
                <div className="w-[50%]">
                  ...
                  >
                    ...
                    <option value="Silk/ रेशमी वस्त्र">
                      Silk/ रेशमी वस्त्र
                    </option>
                ...
                <br />
                <br />
                <h2 className="font-bold">Historical Data</h2>
                ...
                <div className="flex flex-row w-[100%]">
                  <div className="w-[50%]">
                    ...
                    >
                      ...
                      <option value="Shahur (सहुर) san">
                        Shahur (सहुर) san
                      </option>
                      <option value="Shaka (शक) samvat">
                        Shaka (शक) samvat
                      </option>
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <center>
                    ...
                    >
                      ...
                      <option value="Dept. of Nyaya Philosophy, Rashtriya Sanskrit Vidyapeetha">
                        Dept. of Nyaya Philosophy, Rashtriya Sanskrit
                        Vidyapeetha
                      </option>
                      ...
                      <option value="Majuli Collection">
                        Majuli Collection
                      </option>
                      ...
                      <option value="Shahu Sanshodhan Kendra,Shivaji University Kolhapur. (MPC)">
                        Shahu Sanshodhan Kendra,Shivaji University Kolhapur.
                        (MPC)
                      </option>
                      <option value="Shivaji University,Barr. Balasaheb Khardekar Library (S.M. Pujar)">
                        Shivaji University,Barr. Balasaheb Khardekar Library
                        (S.M. Pujar)
                      </option>
                      ...
                      <option value="Sri Samartha Vagdevata Mandir (Domagaonmathasangrah )(MPC)">
                        Sri Samartha Vagdevata Mandir
                        (Domagaonmathasangrah)(MPC)
                      </option>
                  ...
                  <div>
                    <label className="flex flex-col p-2 w-[50%]">
                      <h2 className="font-bold">39.Cover Page Text</h2>
                      <input
                        type="text"
                    ...
                    <label className="flex flex-col p-2 w-[50%]">
                      <h2 className="font-bold">42.Begin text</h2>
                      <input
                        type="text"
                        name="begin_text"
                    ...
                    <label className="flex flex-col p-2 w-[50%]">
                      <h2 className="font-bold">43.Aditional Notes</h2>
                      <input
                        type="text"
                        name="add_notes"
