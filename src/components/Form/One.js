        ...
        <form action="" className="" onSubmit={handleForm1Submit}>
          ...
          <label className="flex flex-col  p-2 bg-blue-200 w-[50%] font-bold">
            ...
            <input
              ...
              value={form1Data.Prim_Sponsorship_name || ""}
              onChange={handleForm1InputChange}
          ...
          <br />
          <br />
          <h2 className="font-bold">Technical Section - Manuscript Details</h2>
          <br />
          <br />
          <label className="flex flex-col p-2 bg-blue-200 w-[50%] font-bold">
            topic:
          ...
          <label className="flex flex-col p-2 bg-blue-200 w-[50%] font-bold">
            ...
            <span className="text-red-700">
              Note: Expected duration of at least two years from commencement of
              the study/ as per university rules and regulations{" "}
            </span>{" "}
            (Eg :3 Year, 2 Months):
            <input
              type="text"
          ...
          <div className="flex flex-col justify-center w-[50%]">
            <center>
              ...
              >
                ...
                <option value="Birch bark/भोज पत्र">Birch bark/भोज पत्र</option>
                ...
                <option value="Palm leaf/ताड़ पत्र">Palm leaf/ताड़ पत्र</option>
                <option value="Paper/कागज">Paper/कागज</option>
                <option value="Parchment/चर्म पत्र">Parchment/चर्म पत्र</option>
...
<br />
          ...
          <div className="flex flex-col justify-center">
            ...
            <label className="flex flex-col p-2 font-bold bg-blue-200">
              Year in MSS:
              <input
                type="text"
                name="MSS_Year"
            ...
            >
              <option value="Bangali (बंगाली) san">Bangali (बंगाली) san</option>
              ...
              <option value="Gupta (गुप्त) samvat">Gupta (गुप्त) samvat</option>
              <option value="Harsha (हर्ष) samvat">Harsha (हर्ष) samvat</option>
              ...
              <option value="Newar (नेवार) samvat">Newar (नेवार) samvat</option>
              <option value="Not Available">Not Available</option>
            ...
            >
              ...
              <option value="Amrita Vishwa Vidyapeetham University, Amritapuri, Kollam,Kerala">
                Amrita Vishwa Vidyapeetham University, Amritapuri, Kollam,Kerala
              </option>
              ...
              <option value="CPR Institute of Indological Research(MPC), Alwarpet, Chennai">
                CPR Institute of Indological Research(MPC), Alwarpet, Chennai
              </option>
              ...
              <option value="Dr. Syed Abdul Mohaimin Quadri Laoubali Institute for Management &amp; Conservation of Manuscripts">
                Dr. Syed Abdul Mohaimin Quadri Laoubali Institute for Management
              ...
              <option value="Himachal Academy of Arts,Culture And Languages,Shimla (Survey)">
                Himachal Academy of Arts,Culture And Languages,Shimla (Survey)
              </option>
              ...
              <option value="Lakshman Pustakalaya">Lakshman Pustakalaya</option>
              ...
              <option value="Oriental Institute, The Maharaja Sayajirao University, Baroda">
                Oriental Institute, The Maharaja Sayajirao University, Baroda
              </option>
              ...
              <option value="SARASVATI, Bhadrakh">SARASVATI, Bhadrakh</option>
              ...
              <option value="SLACJVMSS, Devprayag">SLACJVMSS, Devprayag</option>
              ...
              <option value="Sri Chandrashekharendra Saraswati Viswa Mahavidyalaya,Enathur">
                Sri Chandrashekharendra Saraswati Viswa Mahavidyalaya, Enathur
              </option>
              ...
              <option value="The Asiatic Society">The Asiatic Society</option>
              ...
              <option value="Uttar Pradesh Survey">Uttar Pradesh Survey</option>
            ...
            <label className="flex flex-col p-2 bg-blue-200">
            ...
            <label className="flex flex-col p-2 bg-blue-200">
              <h2 className="font-bold">Flyleaf text</h2>
              <input
                type="text"
                name="flyleaf_text"
            ...
            <label className="flex flex-col p-2 bg-blue-200">
              <h2 className="font-bold">Colophon text</h2>
              <input
                type="text"
                name="colophon_text"
            ...
            <label className="flex flex-col p-2 bg-blue-200">
              <h2 className="font-bold">Begin text</h2>
              <input
                type="text"
                name="begin_text"
            ...
            <label className="flex flex-col p-2 bg-blue-200">
              <h2 className="font-bold">Aditional Notes</h2>
              <input
                type="text"
                name="add_notes"
          ...
          <br />
          <div className="flex flex-col w-[47%] p-4 bg-blue-200">
            <div className="flex flex-col">
              <p>
              ...
              <label className="flex items-center p-2">
                <input
                  ...
                  name="Declaration"
                  value="Disagree"
                  checked={form1Data.Declaration === "Disagree"}
                  onChange={handleForm1InputChange}
                />
