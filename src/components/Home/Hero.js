...
function Hero() {
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">National Institute of Ayurveda, Deemed to be University (De novo) is an apex autonomous Institute under the aegis of Ministry of AYUSH</p>
