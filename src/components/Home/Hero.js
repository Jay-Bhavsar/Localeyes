...
function Hero() {
  return (
    <section class="bg-white dark:bg-gradient-to-r from-gray-900 to-gray-700">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Ayurveda Manuscripts Research Registry of India </h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48  dark:text-gray-400">National Institute of Ayurveda, Deemed to be University (De novo) is an apex autonomous Institute under the aegis of Ministry of AYUSH. NIA, Jaipur has a proud legacy of more than 175 years. The seed of Ayurveda education under the ambit of NIA had started in Jaipur in the form of a Pathshala (school) of indological studies.</p>
